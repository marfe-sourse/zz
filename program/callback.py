 ...
 **⚡️.  ‹ ︙𝔇ℜ𝔞𝔤𝔬𝔫 𝔱𝔢𝔞𝔪 . [𝙻𝙸𝙳𝙾](https://t.me/c_p_8) **
""",
...
async def cbguides(_, query: CallbackQuery):
 ...
 💡 إذا كانت لديك أسئلة  حول هذا البوت ، فيمكنك إخبارنا منن خلال كروب الدعم الخاصة بي هنا ↤ @{GROUP_SUPPORT}
